...
export function PeakHoursHeatmap() {
  ...
  return (
    <ChartCard
      title="Peak hours"
      description="When your gym is busiest — color shows check-in intensity"
      icon={Flame}
      actions={
    ...
    >
      <div className="space-y-1.5">
            ...
            <div className="flex flex-1 gap-1">
              {row.values.map((v, i) => (
                <div
                  ...
                  className={`group relative aspect-square flex-1 rounded-md transition-all hover:scale-110 hover:ring-2 hover:ring-brand-300 ${intensityClass(
                    v,
                  )}`}
                >
                  <span
        ...
        {/* Legend */}
        <div className="flex items-center justify-end gap-2 pt-3 text-[10px] text-slate-500">
          <span>Less</span>
          {[
            "bg-slate-100",
            "bg-brand-200",
